          ...
          <section className="py-12 bg-black sm:py-16 lg:py-20">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col items-center max-w-md mx-auto mt-8 lg:mt-20 lg:flex-row lg:max-w-none">
                        <div className="relative flex-1 w-full overflow-hidden bg-black border border-gray-200 rounded-2xl">
                        ...
                        <div className="relative flex-1 w-full">
                            ...
                            <div className="relative overflow-hidden bg-black border border-gray-200 rounded-2xl">
                                <div className="py-8 px-9">
                        ...
                        <div className="relative flex-1 w-full overflow-hidden bg-black border border-white rounded-2xl">
                            <div className="py-8 px-9">
            ...
            <section className="py-10 bg-black sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <div className="flex flex-col items-center justify-center mt-8 space-y-4 md:space-y-0 md:space-x-4 md:flex-row lg:mt-12">
                        ...
                        <a href="#" title="" className="inline-flex items-center justify-center px-4 py-4 text-white transition-all duration-200 border-2 border-white rounded-md hover:bg-white hover:text-white focus:bg-black focus:text-white" role="button">
