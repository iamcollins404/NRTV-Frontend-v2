                    ...
                    <div className="flex flex-col items-center max-w-md mx-auto mt-8 lg:mt-20 lg:flex-row lg:max-w-none">
                        <div className="relative flex-1 w-full overflow-hidden bg-white border border-gray-200 rounded-2xl">
                            <div className="py-8 px-9">
                                ...
                                <p className="mt-5 text-xl font-medium text-gray-900 font-pj">Sign up or login with your account details inorder to access content.</p>
                            </div>
                        </div>
                        ...
                        <div className="relative flex-1 w-full">
                            ...
                            <div className="relative overflow-hidden bg-white border border-gray-200 rounded-2xl">
                                <div className="py-8 px-9">
                                    ...
                                    <p className="mt-5 text-xl font-medium text-gray-900 font-pj">Procceed to the logged in users account area.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative flex-1 w-full overflow-hidden bg-white border border-gray-200 rounded-2xl">
                            <div className="py-8 px-9">
                                ...
                                <p className="mt-5 text-xl font-medium text-gray-900 font-pj">Start browsing and exploring our entertaining programs all over the platform .</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-10 bg-white sm:py-16 lg:py-24">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <h2 className="mt-10 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Download and Watch</h2>
                        <h2 className=" text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Your Favourite shows online </h2>
