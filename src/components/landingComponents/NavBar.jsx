...
const NavBar = () => {
    ...
    return (
        <header className="bg-lime-50 sticky top-0 z-50 py-3 md:py-3 border-b border-gray-100">
                ...
                <div className="relative flex items-center justify-between">
                    ...
                    <nav className="hidden lg:flex lg:items-center lg:justify-end">
                        <ul className="flex items-center justify-center mt-8 space-x-3 sm:mt-12 lg:justify-end lg:mt-0">
                            <li>
                                <a href="#" target="_blank" title="" className="inline-flex items-center justify-center w-10 h-10 text-gray-900 transition-all duration-200 rounded-full 
